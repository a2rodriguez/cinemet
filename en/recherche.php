...
<html>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="kadra" align="center"><a href="inscription.php">Subscription<br> or <br> Connexion</a>
            <p>To accede on administration page you need a login and pssaword, as an user you have the possibility to INSERT, MODIFY and UPDATE on all tables .</p>
                <br>
            </div>
        </div>
        ...
        <div class="col-md-8 fonony">
            <div class="kadra">
                <div align="center"><b>SELECT YOUR CHOICE</b></div>
            </div>
        
             <div class="row">
                <div class="col-md-4" align="center">
                    <form name="rech_genre" action="resul_genre.php" method="POST">
                        <label for="rgenre">Movie type</label><br>
                        <?php
                ...
                <div class="col-md-4" align="center">
                    <form name="rech_realisateur" action="resul_realisateur.php" method="POST">
                        <label for="rreal">Producor</label>
                        <?php
                            include ('bdd_connect.php');
