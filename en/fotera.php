    ...
    <div class="kolona">
        ...
        <div>
            ...
            <ul style="font-size: 13px;">
                ...
                <li><a href="lesfilms.php">Movies</a></li>
        ...
        <!--COLONNE 2 -->
        <div class="mifindra">
            <span style="font-size:18px;"><strong>ADDRESS</strong></span>
            <ul style="font-size: 13px;">
        ...
        <div class="mifindra">
            ...
            <p style="font-family:Arial;font-size:18px;"><strong>SOCIAL NETWORKS</strong></p><br>
