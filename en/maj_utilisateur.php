            ...
            <?php
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div align="center">
                                <a href="mod_user.php?mdfu=<?php echo $row['iduser']?>"><i class="fas fa-edit"></i></a>
                            </div>
                        </td>
                        <td>
                            <div align="center">
                            <a href="suppr_user.php?fafao=<?php echo $row['iduser']?>"><i class="fas fa-trash-alt"></i></a>
                            </div>
                    ...
                    <br>Number of users in the database :<?php echo $i."<br><br>";
                    $conn=null;
                    ?>
        </div><br><br>
        <div class="col-md-3"></div>
