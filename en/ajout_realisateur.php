...
<html>
    ...
    <?php //include ('menu.php'); ?>
        ...
        <div class="titre">- NEW PRODUCOR -</h2></div>
...
<!--======= TENA IZY =========-->
        <div class="fonony"> <!--  container boaty-->
                ...
                <div class="row">
                <div class="col-50">
                    <label for="nrealisateur">Name of producor</label>
                </div>
                <div class="col-75">
                    <input type="text" name="nrealisateur" id="titre" placeholder="Name of producor..">
                </div>
                </div>
