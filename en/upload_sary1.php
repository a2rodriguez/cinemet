    ...
    if(in_array($fileType, $allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
           ...
           */
           ...
           $sql  = $conn->query("INSERT INTO `films` (`titre`, `categorie`, `duree`, `infos`, `avis`, `liphoto`, `cat_csa`, `datyfin`) VALUES ('".$_POST['titre']."', '".$_POST['categorie']."' , '".$_POST['duree']."' , '".$_POST['infos']."' , '".$_POST['avis']."', '".$targetFilePath."' ,  '".$_POST['cat_csa']."', NOW())");
