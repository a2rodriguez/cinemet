...
<body>
  ...
  <div class="titre">- TYPE OF GENRE -</div>
  <div align="center">
    <?php
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <?php
                ...
                $i=0;
                 /*------------>>>>  AUTRES MANIERES <<<<<<<<<<<<<<<<<<----------------
                $skl = $conn->prepare("SELECT * FROM genre ORDER BY titre ASC");
                $skl->execute();
                while ($row = $skl->fetch())
                {
                    echo "Genre ".$row['description']."<br>";
                }
                $skl = closeCursor();
                */
                ...
                <table>
                    ...
                    <br>Number(s) of type in the database :<?php echo $i."<br><br>";
                    $conn=null;
                    ?>
        </div><br><br>
        <div class="col-md-3"></div>
