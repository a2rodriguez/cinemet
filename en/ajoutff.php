...
<body>
    ...
    <div class="titre">- APPEND MOVIE -</h2></div>
    <div class="fonony">
    <form action="upload_sary_good.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type="text" name="titre" id="titre" placeholder="Title of movie..">
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-25">
                        <label for="l_genre">Category</label>
                    </div>
                    <div class="col-75">
                        <?php
                ...
                <div class="row">
                <div class="col-25">
                <label for="catcsa">CSA Category</label>
                </div>
                <div class="col-75">
...
<!----- ACTEURS ------->
                <div class="row">
                    <div class="col-25">
                        <label for="i_acteur">Actors</label>
                    </div>
                    <div class="col-75">
                        <?php
                            include ('bdd_connect.php');
...
<!----- REALISATEURS ------->
                <div class="row">
                    <div class="col-25">
                        <label for="i_real">Producors</label>
                    </div>
                    <div class="col-75">
                        <?php
                            include ('bdd_connect.php');
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <textarea id="synopsis" name="synopsis" placeholder="Synopsys.." style="height:200px"></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-25">
                        <label for="bannonce">Trailer</label>
                    </div>
                    <div class="col-75">
                        <textarea id="bannonce" name="bannonce" placeholder="Triler of the movie.." style="height:100px"></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        ...
                        <input type="file" name="file" id="sary" placeholder="Movie cover..">
                    </div>
                </div>
