...
<html>
    <head>
    <title>CINEMET - Ajout ACTEUR</title>
            <meta charset="UTF-8">
    ...
    <?php //include ('menu.php'); ?>
        ...
        <div class="titre">- NEW ACTOR -</h2></div>
...
<!--======= TENA IZY =========-->
        <div class="fonony"> <!--  container boaty-->
                ...
                <form action="new_acteur.php" method="POST">
                <!--<form action="" method="POST">-->
                <div class="row">
                <div class="col-50">
                    <label for="nacteur">Name of actor</label>
                </div>
                <div class="col-75">
                    <input type="text" name="nacteur" id="titre" placeholder="Name of actor..">
                </div>
                </div>
                ...
                <div class="col-50" align="center"><input type="submit" name="Register" value="Register"></div>
                </div>
            </form>
            </div><br><br>
